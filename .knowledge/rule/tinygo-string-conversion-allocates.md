...
```yaml
observed: tinygo 0.42.0 linux/amd64, encoding/xml alloc tests, 2026-09-25
measured:
  ...
  unsafe_string: >
    ...
    compiler, and is what encoding/xml.Equal does behind a length check
how_it_was_missed: >
...
rule: >
  ...
  only such site so its lifetime argument is written once. In encoding/xml
