...
type Config struct {
	...
	User           string
	Password       string
	TLSConfig      *TLSConfig // nil disables TLS
...
// configTLS uses libpq's TLS parameters to construct  []*TLSConfig. It is
// necessary to allow returning multiple TLS configs as sslmode "allow" and
// "prefer" allow fallback.
func configTLS(settings map[string]string, thisHost string, parseConfigOptions ParseConfigOptions) ([]*TLSConfig, error) {
	host := thisHost
