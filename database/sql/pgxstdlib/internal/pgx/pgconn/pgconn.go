...
import (
	...
	"github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/internal/iobufpool"
	"github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/internal/pgio"
	"github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/pgconn/ctxwatch"
	"github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/pgconn/internal/bgreader"
	"github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/pgproto3"
	"github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/pgtype"
)
...
type PgConn struct {
	conn              net.Conn
	tlsConfig         *TLSConfig        // tls.Config that conn was negotiated with; nil if conn is not TLS
...
func startTLS(ctx context.Context, conn net.Conn, tlsConfig *TLSConfig) (net.Conn, error) {
	...
	return upgradeConn(ctx, conn, tlsConfig)
}
