...
[github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/stdlib] to use pgx as a database/sql compatible driver. See that package's documentation for
details.
...
[github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/pgxpool] for a concurrency safe connection pool.
...
pgx supports tracing by setting [ConnConfig.Tracer]. To combine several tracers you can use the [github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/multitracer.Tracer].

In addition, the [github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/tracelog] package provides the [github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/tracelog.TraceLog] type which lets a
traditional logger act as a [QueryTracer].

For debug tracing of the actual PostgreSQL wire protocol messages see [github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/pgproto3].

Lower Level PostgreSQL Functionality

[github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/pgconn] contains a lower level PostgreSQL driver roughly at the level of libpq. [Conn] is
...
import (
	_ "github.com/shibukawa/tinygodriver/database/sql/pgxstdlib/internal/pgx/pgconn" // Just for allowing godoc to resolve "pgconn"
)
